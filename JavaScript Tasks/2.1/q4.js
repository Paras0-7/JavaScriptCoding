...
export const getTotalAmount = function(days){

    const chargePerDay = 40;
    let totalAmount;
    if(days>=7){
        totalAmount = (days*chargePerDay)-50;

    }
    else if(days>=3){
        totalAmount = (days*chargePerDay)-20;
    }
    else{
        totalAmount = (days*chargePerDay);
    }

    console.log(`Total rental amount of car is : ${totalAmount}`)
}
